            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/admin/zapros">
                                <span class="nav-link-text">Запросы на смену статуса</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/admin/agents">
                                <span class="nav-link-text">Агенты (Партнеры)</span>
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/admin/tariffs">
                                <span class="nav-link-text">Список покупок</span>
                            </a>
                        </li>
                        <li class="nav-item">
