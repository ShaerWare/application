...
class AdminController extends Controller {
	...
	public function agentsAction() {
		...
		$pagination = new Pagination($this->route, $this->model->agentsCount());
		$vars = [
			'pagination' => $pagination->get(),
			'list' => $this->model->agentsList($this->route),
		];
		//debug($vars);
		$this->view->render('Игроки', $vars);
	}
